...
import gym
import copy
import LinguaFrancapong_lf_3 as lf
from LinguaFrancapong_lf_3 import (
...
# Python class for reactor _pong_lf_3_main
class __pong_lf_3_main:
...
# Instantiate classes
pong_lf_3_main_lf = [None] * 1
pong_lf_3_client_lf = [None] * 3
pong_lf_3_server_lf = [None] * 1
pong_lf_3_delay_lf = [None] * 1
# Start initializing pong_lf_3 of class _pong_lf_3_main
for pong_lf_3_main_i in range(1):
    bank_index = pong_lf_3_main_i
    pong_lf_3_main_lf[0] = __pong_lf_3_main(
        _bank_index=0,
    )
    # Start initializing pong_lf_3.client of class _clientreactor
    for pong_lf_3_client_i in range(3):
        bank_index = pong_lf_3_client_i
        pong_lf_3_client_lf[pong_lf_3_client_i] = __clientreactor(
            _bank_index=pong_lf_3_client_i,
        )
    # Start initializing pong_lf_3.server of class _serverreactor
    for pong_lf_3_server_i in range(1):
        bank_index = pong_lf_3_server_i
        pong_lf_3_server_lf[0] = __serverreactor(
            _bank_index=0,
        )
    # Start initializing pong_lf_3.delay of class __lf_gendelay_0
    for pong_lf_3_delay_i in range(1):
        bank_index = pong_lf_3_delay_i
        pong_lf_3_delay_lf[0] = ___lf_gendelay_0(
            _bank_index=pong_lf_3_delay_i,
            _delay=0,
        )
