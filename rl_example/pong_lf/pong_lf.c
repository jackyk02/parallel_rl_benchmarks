...
// file://mnt/c/Users/jacky/Desktop/simple_multi/src/pong_lf.lf
#define LOG_LEVEL 2
#define TARGET_FILES_DIRECTORY "/mnt/c/Users/jacky/Desktop/simple_multi/src-gen/pong_lf"
...
void _lf_initialize_trigger_objects() {
    ...
    __lf_gendelay_0_self_t* pong_lf_delay_self[1];
    SUPPRESS_UNUSED_WARNING(pong_lf_delay_self);
    // ***** Start initializing pong_lf of class pong_lf
    pong_lf_main_self[0] = new__pong_lf_main();
    pong_lf_main_self[0]->base.environment = &envs[pong_lf_main];
    pong_lf_main_self[0]->_lf_name = "pong_lf_main_lf";
    ...
    for (int pong_lf_client_i = 0; pong_lf_client_i < 6; pong_lf_client_i++) {
        ...
        pong_lf_client_self[pong_lf_client_i]->_lf_name = "pong_lf_client_lf";
        pong_lf_client_self[pong_lf_client_i]->_lf_py_reaction_function_0 = 
        get_python_function("__main__", 
            pong_lf_client_self[pong_lf_client_i]->_lf_name,
            pong_lf_client_i,
            "reaction_function_0");
        if(pong_lf_client_self[pong_lf_client_i]->_lf_py_reaction_function_0 == NULL) {
            lf_print_error_and_exit("Could not load function reaction_function_0");
        }
        pong_lf_client_self[pong_lf_client_i]->_lf_py_reaction_function_1 = 
        get_python_function("__main__", 
            pong_lf_client_self[pong_lf_client_i]->_lf_name,
            pong_lf_client_i,
            "reaction_function_1");
        if(pong_lf_client_self[pong_lf_client_i]->_lf_py_reaction_function_1 == NULL) {
            lf_print_error_and_exit("Could not load function reaction_function_1");
        }
        // width of -2 indicates that it is not a multiport.
        pong_lf_client_self[pong_lf_client_i]->_lf_updated_parameters_width = -2;
        // width of -2 indicates that it is not a multiport.
        pong_lf_client_self[pong_lf_client_i]->_lf_global_parameters_width = -2;
        envs[pong_lf_main].startup_reactions[startup_reaction_count[pong_lf_main]++] = &pong_lf_client_self[pong_lf_client_i]->_lf__reaction_0;
        SUPPRESS_UNUSED_WARNING(_lf_watchdog_count);
    
        pong_lf_client_self[pong_lf_client_i]->_lf__reaction_0.deadline = NEVER;
        pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.deadline = NEVER;
        //***** End initializing pong_lf.client
    }
    {
        // ***** Start initializing pong_lf.server of class serverReactor
        pong_lf_server_self[0] = new__serverreactor();
        pong_lf_server_self[0]->base.environment = &envs[pong_lf_main];
        pong_lf_server_self[0]->_lf_name = "pong_lf_server_lf";
        pong_lf_server_self[0]->_lf_py_reaction_function_0 = 
        get_python_function("__main__", 
            pong_lf_server_self[0]->_lf_name,
            0,
            "reaction_function_0");
        if(pong_lf_server_self[0]->_lf_py_reaction_function_0 == NULL) {
            lf_print_error_and_exit("Could not load function reaction_function_0");
        }
        pong_lf_server_self[0]->_lf_py_reaction_function_1 = 
        get_python_function("__main__", 
            pong_lf_server_self[0]->_lf_name,
            0,
            "reaction_function_1");
        if(pong_lf_server_self[0]->_lf_py_reaction_function_1 == NULL) {
            lf_print_error_and_exit("Could not load function reaction_function_1");
        }
        // width of -2 indicates that it is not a multiport.
        ...
        pong_lf_server_self[0]->_lf__reaction_0.deadline = NEVER;
        pong_lf_server_self[0]->_lf__reaction_1.deadline = NEVER;
        //***** End initializing pong_lf.server
    }
    // Reactor is a bank. Iterate over bank members.
    for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
        // ***** Start initializing pong_lf.delay of class _lf_GenDelay_0
        pong_lf_delay_self[0] = new___lf_gendelay_0();
        pong_lf_delay_self[0]->base.environment = &envs[pong_lf_main];
        pong_lf_delay_self[0]->_lf_name = "pong_lf_delay_lf";
        // width of -2 indicates that it is not a multiport.
        pong_lf_delay_self[0]->_lf_out_width = -2;
        // width of -2 indicates that it is not a multiport.
        pong_lf_delay_self[0]->_lf_inp_width = -2;
        SUPPRESS_UNUSED_WARNING(_lf_watchdog_count);
        // Initializing action pong_lf.delay.act
        pong_lf_delay_self[0]->_lf__act.offset = 0;
        pong_lf_delay_self[0]->_lf__act.period = -1;
        pong_lf_delay_self[0]->_lf__act.mode = NULL;
        _lf_initialize_template((token_template_t*)
                &(pong_lf_delay_self[0]->_lf__act),
        0);
        pong_lf_delay_self[0]->_lf__act.status = absent;
        pong_lf_delay_self[0]->_lf__reaction_0.deadline = NEVER;
        pong_lf_delay_self[0]->_lf__reaction_1.deadline = NEVER;
        //***** End initializing pong_lf.delay
    }
    //***** End initializing pong_lf
    // **** Start deferred initialize for pong_lf
    {
        ...
        for (int pong_lf_client_i = 0; pong_lf_client_i < 6; pong_lf_client_i++) {
            ...
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_0.num_outputs = 0;
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
            }
            
            // ** End initialization for reaction 0 of pong_lf.client
            // Total number of outputs (single ports and multiport channels)
            // produced by reaction_2 of pong_lf.client.
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.num_outputs = 1;
            // Allocate memory for triggers[] and triggered_sizes[] on the reaction_t
            // struct for this reaction.
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.triggers = (trigger_t***)_lf_allocate(
                    1, sizeof(trigger_t**),
                    &pong_lf_client_self[pong_lf_client_i]->base.allocations);
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.triggered_sizes = (int*)_lf_allocate(
                    1, sizeof(int),
                    &pong_lf_client_self[pong_lf_client_i]->base.allocations);
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.output_produced = (bool**)_lf_allocate(
                    1, sizeof(bool*),
                    &pong_lf_client_self[pong_lf_client_i]->base.allocations);
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
                {
                    pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.output_produced[count++] = &pong_lf_client_self[pong_lf_client_i]->_lf_updated_parameters.is_present;
                }
            }
            
            // ** End initialization for reaction 1 of pong_lf.client
        
        }
        // **** End of deferred initialize for pong_lf.client
        // **** Start deferred initialize for pong_lf.server
        {
        
            // Total number of outputs (single ports and multiport channels)
            // produced by reaction_1 of pong_lf.server.
            pong_lf_server_self[0]->_lf__reaction_0.num_outputs = 1;
            // Allocate memory for triggers[] and triggered_sizes[] on the reaction_t
            // struct for this reaction.
            pong_lf_server_self[0]->_lf__reaction_0.triggers = (trigger_t***)_lf_allocate(
                    1, sizeof(trigger_t**),
                    &pong_lf_server_self[0]->base.allocations);
            pong_lf_server_self[0]->_lf__reaction_0.triggered_sizes = (int*)_lf_allocate(
                    1, sizeof(int),
                    &pong_lf_server_self[0]->base.allocations);
            pong_lf_server_self[0]->_lf__reaction_0.output_produced = (bool**)_lf_allocate(
                    1, sizeof(bool*),
                    &pong_lf_server_self[0]->base.allocations);
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
                {
                    pong_lf_server_self[0]->_lf__reaction_0.output_produced[count++] = &pong_lf_server_self[0]->_lf_global_parameters.is_present;
                }
            }
            
            // ** End initialization for reaction 0 of pong_lf.server
            // Total number of outputs (single ports and multiport channels)
            // produced by reaction_2 of pong_lf.server.
            pong_lf_server_self[0]->_lf__reaction_1.num_outputs = 1;
            // Allocate memory for triggers[] and triggered_sizes[] on the reaction_t
            // struct for this reaction.
            pong_lf_server_self[0]->_lf__reaction_1.triggers = (trigger_t***)_lf_allocate(
                    1, sizeof(trigger_t**),
                    &pong_lf_server_self[0]->base.allocations);
            pong_lf_server_self[0]->_lf__reaction_1.triggered_sizes = (int*)_lf_allocate(
                    1, sizeof(int),
                    &pong_lf_server_self[0]->base.allocations);
            pong_lf_server_self[0]->_lf__reaction_1.output_produced = (bool**)_lf_allocate(
                    1, sizeof(bool*),
                    &pong_lf_server_self[0]->base.allocations);
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
                {
                    pong_lf_server_self[0]->_lf__reaction_1.output_produced[count++] = &pong_lf_server_self[0]->_lf_global_parameters.is_present;
                }
            }
            
            // ** End initialization for reaction 1 of pong_lf.server
        
        }
        // **** End of deferred initialize for pong_lf.server
        // **** Start deferred initialize for pong_lf.delay
        // Reactor is a bank. Iterate over bank members.
        for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
        
            // Total number of outputs (single ports and multiport channels)
            // produced by reaction_1 of pong_lf.delay.
            pong_lf_delay_self[0]->_lf__reaction_0.num_outputs = 1;
            // Allocate memory for triggers[] and triggered_sizes[] on the reaction_t
            // struct for this reaction.
            pong_lf_delay_self[0]->_lf__reaction_0.triggers = (trigger_t***)_lf_allocate(
                    1, sizeof(trigger_t**),
                    &pong_lf_delay_self[0]->base.allocations);
            pong_lf_delay_self[0]->_lf__reaction_0.triggered_sizes = (int*)_lf_allocate(
                    1, sizeof(int),
                    &pong_lf_delay_self[0]->base.allocations);
            pong_lf_delay_self[0]->_lf__reaction_0.output_produced = (bool**)_lf_allocate(
                    1, sizeof(bool*),
                    &pong_lf_delay_self[0]->base.allocations);
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
                {
                    pong_lf_delay_self[0]->_lf__reaction_0.output_produced[count++] = &pong_lf_delay_self[0]->_lf_out.is_present;
                }
            }
            
            // ** End initialization for reaction 0 of pong_lf.delay
            // Total number of outputs (single ports and multiport channels)
            // produced by reaction_2 of pong_lf.delay.
            pong_lf_delay_self[0]->_lf__reaction_1.num_outputs = 0;
            {
                int count = 0; SUPPRESS_UNUSED_WARNING(count);
            }
            
            // ** End initialization for reaction 1 of pong_lf.delay
        
        }
        // **** End of deferred initialize for pong_lf.delay
    }
    // **** End of deferred initialize for pong_lf
    // **** Start non-nested deferred initialize for pong_lf
    {
        ...
        for (int pong_lf_client_i = 0; pong_lf_client_i < 6; pong_lf_client_i++) {
            ...
            // Iterate over range pong_lf.client.updated_parameters(0,6)->[pong_lf.server.updated_parameters(0,6)].
            {
                ...
                for (int range_count = 0; range_count < 0 + 6; range_count++) {
                    ...
                    pong_lf_client_self[src_runtime]->_lf_updated_parameters._base.num_destinations = 1;
                    pong_lf_client_self[src_runtime]->_lf_updated_parameters._base.source_reactor = (self_base_t*)pong_lf_client_self[src_runtime];
            ...
            }
            {
                ...
                // Iterate over range pong_lf.client.updated_parameters(0,6)->[pong_lf.server.updated_parameters(0,6)].
                {
                    ...
                    for (int range_count = 0; range_count < 0 + 6; range_count++) {
                        ...
                        int src_bank = range_mr.digits[1]; // Bank index.
                        SUPPRESS_UNUSED_WARNING(src_bank);
                        // Reaction 1 of pong_lf.client triggers 1 downstream reactions
                        // through port pong_lf.client.updated_parameters.
                        pong_lf_client_self[src_runtime]->_lf__reaction_1.triggered_sizes[triggers_index[src_runtime]] = 1;
                        // For reaction 1 of pong_lf.client, allocate an
                        // array of trigger pointers for downstream reactions through port pong_lf.client.updated_parameters
                        trigger_t** trigger_array = (trigger_t**)_lf_allocate(
                                1, sizeof(trigger_t*),
                                &pong_lf_client_self[src_runtime]->base.allocations); 
                        pong_lf_client_self[src_runtime]->_lf__reaction_1.triggers[triggers_index[src_runtime]++] = trigger_array;
                        mixed_radix_incr(&range_mr);
                    }
                }
        ...
        // **** End of non-nested deferred initialize for pong_lf.client
        // **** Start non-nested deferred initialize for pong_lf.server
        {
        
            // For reference counting, set num_destinations for port pong_lf.server.global_parameters.
            // Iterate over range pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)].
            {
                ...
                pong_lf_server_self[src_runtime]->_lf_global_parameters._base.num_destinations = 1;
                pong_lf_server_self[src_runtime]->_lf_global_parameters._base.source_reactor = (self_base_t*)pong_lf_server_self[src_runtime];
            }
            {
                ...
                // Iterate over range pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)].
                {
                    ...
                    int src_bank = 0; SUPPRESS_UNUSED_WARNING(src_bank); // Bank index.
                    int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
                    // Reaction 0 of pong_lf.server triggers 1 downstream reactions
                    // through port pong_lf.server.global_parameters.
                    pong_lf_server_self[src_runtime]->_lf__reaction_0.triggered_sizes[triggers_index[src_runtime]] = 1;
                    // For reaction 0 of pong_lf.server, allocate an
                    // array of trigger pointers for downstream reactions through port pong_lf.server.global_parameters
                    trigger_t** trigger_array = (trigger_t**)_lf_allocate(
                            1, sizeof(trigger_t*),
                            &pong_lf_server_self[src_runtime]->base.allocations); 
                    pong_lf_server_self[src_runtime]->_lf__reaction_0.triggers[triggers_index[src_runtime]++] = trigger_array;
                }
                for (int i = 0; i < 1; i++) triggers_index[i] = 0;
                // Iterate over ranges pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)] and pong_lf.delay.inp(0,1).
                {
                    ...
                    SUPPRESS_UNUSED_WARNING(src_bank);
                    // Iterate over range pong_lf.delay.inp(0,1).
                    {
                        ...
                        int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
                        // Point to destination port pong_lf.delay.inp's trigger struct.
                        pong_lf_server_self[src_runtime]->_lf__reaction_0.triggers[triggers_index[src_runtime] + src_channel][0] = &pong_lf_delay_self[dst_runtime]->_lf__inp;
                    }
                }
            }
            {
                ...
                // Iterate over range pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)].
                {
                    ...
                    int src_bank = 0; SUPPRESS_UNUSED_WARNING(src_bank); // Bank index.
                    int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
                    // Reaction 1 of pong_lf.server triggers 1 downstream reactions
                    // through port pong_lf.server.global_parameters.
                    pong_lf_server_self[src_runtime]->_lf__reaction_1.triggered_sizes[triggers_index[src_runtime]] = 1;
                    // For reaction 1 of pong_lf.server, allocate an
                    // array of trigger pointers for downstream reactions through port pong_lf.server.global_parameters
                    trigger_t** trigger_array = (trigger_t**)_lf_allocate(
                            1, sizeof(trigger_t*),
                            &pong_lf_server_self[src_runtime]->base.allocations); 
                    pong_lf_server_self[src_runtime]->_lf__reaction_1.triggers[triggers_index[src_runtime]++] = trigger_array;
                }
                for (int i = 0; i < 1; i++) triggers_index[i] = 0;
                // Iterate over ranges pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)] and pong_lf.delay.inp(0,1).
                {
                    ...
                    // Iterate over range pong_lf.delay.inp(0,1).
                    {
                        ...
                        int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
                        // Point to destination port pong_lf.delay.inp's trigger struct.
                        pong_lf_server_self[src_runtime]->_lf__reaction_1.triggers[triggers_index[src_runtime] + src_channel][0] = &pong_lf_delay_self[dst_runtime]->_lf__inp;
                    }
                }
            }
        
        }
        // **** End of non-nested deferred initialize for pong_lf.server
        // **** Start non-nested deferred initialize for pong_lf.delay
        // Reactor is a bank. Iterate over bank members.
        for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
            ...
            }
            {
                ...
                // Iterate over ranges pong_lf.delay.out(0,1)->[pong_lf.client.global_parameters(0,1), pong_lf.client.global_parameters(5,1), pong_lf.client.global_parameters(4,1), pong_lf.client.global_parameters(3,1), pong_lf.client.global_parameters(2,1), pong_lf.client.global_parameters(1,1)] and pong_lf.client.global_parameters(0,1).
                {
                    ...
                    int src_bank = 0; // Bank index.
                    SUPPRESS_UNUSED_WARNING(src_bank);
                    // Iterate over range pong_lf.client.global_parameters(0,1).
                    {
                        int dst_runtime = 0; SUPPRESS_UNUSED_WARNING(dst_runtime); // Runtime index.
                        int dst_channel = 0; SUPPRESS_UNUSED_WARNING(dst_channel); // Channel index.
                        int dst_bank = 0; SUPPRESS_UNUSED_WARNING(dst_bank); // Bank index.
                ...
                // Iterate over ranges pong_lf.delay.out(0,1)->[pong_lf.client.global_parameters(0,1), pong_lf.client.global_parameters(5,1), pong_lf.client.global_parameters(4,1), pong_lf.client.global_parameters(3,1), pong_lf.client.global_parameters(2,1), pong_lf.client.global_parameters(1,1)] and pong_lf.client.global_parameters(2,1).
                {
                    ...
                    int src_bank = 0; // Bank index.
                    SUPPRESS_UNUSED_WARNING(src_bank);
                    // Iterate over range pong_lf.client.global_parameters(2,1).
                    {
                ...
                // Iterate over ranges pong_lf.delay.out(0,1)->[pong_lf.client.global_parameters(0,1), pong_lf.client.global_parameters(5,1), pong_lf.client.global_parameters(4,1), pong_lf.client.global_parameters(3,1), pong_lf.client.global_parameters(2,1), pong_lf.client.global_parameters(1,1)] and pong_lf.client.global_parameters(1,1).
                {
                    ...
                    int src_bank = 0; // Bank index.
                    SUPPRESS_UNUSED_WARNING(src_bank);
                    // Iterate over range pong_lf.client.global_parameters(1,1).
                    {
        ...
        // **** End of non-nested deferred initialize for pong_lf.delay
    }
    ...
    // Connect inputs and outputs for reactor pong_lf.server.
    // Connect pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)] to port pong_lf.delay.inp(0,1)
    // Iterate over ranges pong_lf.server.global_parameters(0,1)->[pong_lf.delay.inp(0,1)] and pong_lf.delay.inp(0,1).
    {
        int src_runtime = 0; // Runtime index.
        SUPPRESS_UNUSED_WARNING(src_runtime);
        ...
        // Iterate over range pong_lf.delay.inp(0,1).
        {
            ...
            int dst_bank = 0; SUPPRESS_UNUSED_WARNING(dst_bank); // Bank index.
            int range_count = 0; SUPPRESS_UNUSED_WARNING(range_count);
            pong_lf_delay_self[dst_runtime]->_lf_inp = (__lf_gendelay_0_inp_t*)&pong_lf_server_self[src_runtime]->_lf_global_parameters;
        }
    }
    ...
    for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
        // Reactor is a bank. Iterate over bank members.
        for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
            // Add action pong_lf.delay.act to array of is_present fields.
            envs[pong_lf_main].is_present_fields[0] 
                    = &pong_lf_delay_self[0]->_lf_act.is_present;
            #ifdef FEDERATED_DECENTRALIZED
            // Add action pong_lf.delay.act to array of intended_tag fields.
            envs[pong_lf_main]._lf_intended_tag_fields[0] 
                    = &pong_lf_delay_self[0]->_lf_act.intended_tag;
    ...
    }
    {
        ...
        for (int pong_lf_client_i = 0; pong_lf_client_i < 6; pong_lf_client_i++) {
            ...
            #ifdef FEDERATED_DECENTRALIZED
            // Add port pong_lf.client.updated_parameters to array of intended_tag fields.
            envs[pong_lf_main]._lf_intended_tag_fields[1 + count] = &pong_lf_client_self[pong_lf_client_i]->_lf_updated_parameters.intended_tag;
            #endif // FEDERATED_DECENTRALIZED
            count++;
        }
    }
    ...
    // Set reaction priorities for ReactorInstance pong_lf
    {
        ...
        for (int pong_lf_client_i = 0; pong_lf_client_i < 6; pong_lf_client_i++) {
            ...
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_0.index = 0xffffffffffff0000LL;
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.chain_id = 1;
            // index is the OR of level 1 and 
            // deadline 9223372036854775807 shifted left 16 bits.
            pong_lf_client_self[pong_lf_client_i]->_lf__reaction_1.index = 0xffffffffffff0001LL;
        }
    
    
        // Set reaction priorities for ReactorInstance pong_lf.server
        {
            pong_lf_server_self[0]->_lf__reaction_0.chain_id = 1;
            // index is the OR of level 0 and 
            // deadline 9223372036854775807 shifted left 16 bits.
            pong_lf_server_self[0]->_lf__reaction_0.index = 0xffffffffffff0000LL;
            pong_lf_server_self[0]->_lf__reaction_1.chain_id = 1;
            // index is the OR of level 2 and 
            // deadline 9223372036854775807 shifted left 16 bits.
            pong_lf_server_self[0]->_lf__reaction_1.index = 0xffffffffffff0002LL;
        }
    
    
        // Set reaction priorities for ReactorInstance pong_lf.delay
        // Reactor is a bank. Iterate over bank members.
        for (int pong_lf_delay_i = 0; pong_lf_delay_i < 1; pong_lf_delay_i++) {
            pong_lf_delay_self[0]->_lf__reaction_0.chain_id = 1;
            // index is the OR of level 0 and 
            // deadline 9223372036854775807 shifted left 16 bits.
            pong_lf_delay_self[0]->_lf__reaction_0.index = 0xffffffffffff0000LL;
            pong_lf_delay_self[0]->_lf__reaction_1.chain_id = 1;
            // index is the OR of level 3 and 
            // deadline 9223372036854775807 shifted left 16 bits.
            pong_lf_delay_self[0]->_lf__reaction_1.index = 0xffffffffffff0003LL;
        }
