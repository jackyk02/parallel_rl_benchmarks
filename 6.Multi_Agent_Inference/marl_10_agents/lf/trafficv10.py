...
# Python class for reactor _trafficv10_main
class __trafficv10_main:
...
# Instantiate classes
trafficv10_main_lf = [None] * 1
trafficv10_client_lf = [None] * 10
trafficv10_server_lf = [None] * 1
trafficv10_delay_lf = [None] * 1
# Start initializing trafficv10 of class _trafficv10_main
for trafficv10_main_i in range(1):
    bank_index = trafficv10_main_i
    trafficv10_main_lf[0] = __trafficv10_main(
        _bank_index=0,
    )
    # Start initializing trafficv10.client of class _clientreactor
    for trafficv10_client_i in range(10):
        bank_index = trafficv10_client_i
        trafficv10_client_lf[trafficv10_client_i] = __clientreactor(
            _bank_index=trafficv10_client_i,
        )
    # Start initializing trafficv10.server of class _serverreactor
    for trafficv10_server_i in range(1):
        bank_index = trafficv10_server_i
        trafficv10_server_lf[0] = __serverreactor(
            _bank_index=0,
        )
    # Start initializing trafficv10.delay of class __lf_gendelay_0
    for trafficv10_delay_i in range(1):
        bank_index = trafficv10_delay_i
        trafficv10_delay_lf[0] = ___lf_gendelay_0(
            _bank_index=trafficv10_delay_i,
            _delay=0,
        )
