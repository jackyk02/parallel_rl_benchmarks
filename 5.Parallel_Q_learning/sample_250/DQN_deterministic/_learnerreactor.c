...
#include "include/DQN_deterministic/LearnerReactor.h"
...
void _learnerreactorreaction_function_0(void* instance_args){
    ...
    #line 160 "/mnt/c/Users/jacky/Desktop/simple_multi/src/DQN_deterministic.lf"
...
void _learnerreactorreaction_function_1(void* instance_args){
    ...
    _learnerreactor_gradients_t* gradients = &self->_lf_gradients;
    #line 168 "/mnt/c/Users/jacky/Desktop/simple_multi/src/DQN_deterministic.lf"
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
